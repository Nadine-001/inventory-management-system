Public Class frm_transaction
    ...
    Private Sub btnSup_supSearch_Click_1(sender As Object, e As EventArgs) Handles btnSup_supSearch.Click
        frm_supplier.Show()
        txt_suplierId.Clear()
    End Sub

    Private Sub btnSup_itemSearch_Click_1(sender As Object, e As EventArgs) Handles btnSup_itemSearch.Click
        frm_StockMaster.Show()
        txtSup_itemid.Clear()
    End Sub

    Private Sub btnSup_addtocart_Click_1(sender As Object, e As EventArgs) Handles btnSup_addtocart.Click
        Try
            If txtSup_qty.Text <> "" Then
                ...
                Else
                    If dtgSup_cartlist.CurrentRow.Cells(0).Value <> txtSup_itemid.Text Then
                        ...
                        cleartext(GroupBox1)
                    Else
                        MsgBox("Item is already in the cart", MsgBoxStyle.Exclamation, "Inventory Management System")
                    End If
                End If
            Else
                MsgBox("You must fill up all the fields.", MsgBoxStyle.Exclamation, "Inventory Management System")
            End If
    ...
    Private Sub btnSup_save_Click_1(sender As Object, e As EventArgs) Handles btnSup_save.Click
        ...
        MsgBox("Item(s) has been save in the database.", MsgBoxStyle.Information, "Inventory Management System")
    ...
    Private Sub btnSup_edit_Click_1(sender As Object, e As EventArgs) Handles btnSup_edit.Click
        Try
    ...
    Private Sub aa_Click_1(sender As Object, e As EventArgs) Handles aa.Click
        dtgSup_cartlist.Rows.Clear()
    End Sub
    ...
    Private Sub txt_suplierId_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_suplierId.TextChanged
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                txtSup_lname.Text = dt.Rows(0).Item("LASTNAME")
            Else
                txtSup_fname.Clear()
                txtSup_lname.Clear()
            End If
    ...
    Private Sub txtSup_qty_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtSup_qty.TextChanged
        ...
        Catch ex As Exception
            If txtSup_qty.Text <> "" Then
                MsgBox("Quantity must be a number", MsgBoxStyle.Exclamation, "Inventory Management System")
                txtSup_qty.Text = ""
            Else
    ...
    Private Sub btnCus_save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCus_save.Click
        If txt_cusid.Text = "" Then
            MsgBox("Empty field(s) must be filled up!", MsgBoxStyle.Exclamation, "Inventory Management System")
            Return
        End If

        If dtCus_addedlist.RowCount = 0 Then
            MsgBox("Cart is empty!", MsgBoxStyle.Exclamation, "Inventory Management System")
            Return
        End If
            ...
            For i As Integer = 0 To dtCus_addedlist.Rows.Count - 1
                If dtCus_addedlist.Rows(i).Cells(0).Value = row.Item(0) Then
                    If dtCus_addedlist.Rows(i).Cells(4).Value > row.Item(1) Then
                        MsgBox("The Quantity of the item ( " & dtCus_addedlist.Rows(i).Cells(1).Value & " ) is greater than the available quantity of it.", MsgBoxStyle.Exclamation, "Inventory Management System")
                        Exit Sub
                    End If
                End If
            Next
    ...
    Private Sub btnreturn_save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreturn_save.Click
        If txttransactionid.Text = "" Then
            MsgBox("There are empty fields left that must be fill up!", MsgBoxStyle.Exclamation, "Inventory Management System")
            Return
        End If
            ...
            For i As Integer = 0 To dtgreturn_cart.Rows.Count - 1
                If dtgreturn_cart.Rows(i).Cells(0).Value = row.Item(0) Then
                    If dtgreturn_cart.Rows(i).Cells(4).Value > row.Item(1) Then
                        MsgBox("The Quantity of the item ( " & dtgreturn_cart.Rows(i).Cells(1).Value & " ) is greater than the available quantity of it.", MsgBoxStyle.Exclamation, "Inventory Management System")
                        Exit Sub
                    End If
                End If
            Next
        ...
        MsgBox("Item(s) has been returned.", MsgBoxStyle.Information, "Inventory Management System")
    ...
    Private Sub btnreturn_Search_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreturn_Search.Click
        frmview_transaction.Show()
        frmview_transaction.Focus()
    End Sub

    Private Sub btnviewstockin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnviewstockin.Click
    ...
    Private Sub btnviewreturn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnviewreturn.Click
        frmview_return.Show()
