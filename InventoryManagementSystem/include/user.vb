        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                If dt.Rows(0).Item("type") = "Administrator" Then
                    MsgBox("Welcome, " & dt.Rows(0).Item("type"), MsgBoxStyle.OkOnly, "Inventory Management System")
                    enable_disable(True)
                    With Form1
                ...
                End If
            Else
                MsgBox("Account not found!", MsgBoxStyle.Information, "Inventory Management System")
            End If
